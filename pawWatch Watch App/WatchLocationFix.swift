//
//  WatchLocationFix.swift
//  pawWatch Watch App
//
//  Purpose: Provide the LocationFix model in the watchOS target to resolve
//           "Cannot find type 'LocationFix' in scope" and ensure wire
//           compatibility with the iOS side.
//
//  Mirrors the LocationFix used in the iOS/pawWatchFeature module so JSON
//  encoding/decoding remains consistent across devices.
//
//  Created: 2025-11-06
//  Swift: 6.2
