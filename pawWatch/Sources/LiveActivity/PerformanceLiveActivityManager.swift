...
enum PerformanceLiveActivityManager {
    private static let logger = Logger(subsystem: PawWatchLog.subsystem, category: "LiveActivity")
...
actor LiveActivityPushCoordinator {
    ...
    private let logger = Logger(subsystem: PawWatchLog.subsystem, category: "LiveActivityPush")
...
enum LiveActivityPushHandler {
    private static let logger = Logger(subsystem: PawWatchLog.subsystem, category: "LiveActivityPush")
